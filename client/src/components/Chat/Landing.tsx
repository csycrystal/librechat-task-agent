...
const containerClassName =
  'neu-disk shadow-stroke relative flex h-full items-center justify-center rounded-full text-text-primary dark:after:shadow-none ';
  ...
  return (
    ...
    >
      <div ref={contentRef} className="flex flex-col items-center gap-0 p-2">
        ...
        >
          <div className={`neu-glow relative size-10 justify-center ${textHasMultipleLines ? 'mb-2' : ''}`}>
            {isTemporary ? (
