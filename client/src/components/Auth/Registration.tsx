...
const Registration: React.FC = () => {
  ...
  const authInputClassName =
    'webkit-dark-styles transition-color peer h-auto w-full rounded-2xl neu-auth-input px-3.5 pb-2.5 pt-3 text-text-primary duration-200 focus:outline-none';
  const authSecretInputClassName = `${authInputClassName} pr-12`;
  const authLabelClassName =
    'absolute start-3 top-1.5 z-10 origin-[0] -translate-y-4 scale-75 transform neu-auth-label px-2 text-sm text-text-secondary-alt duration-200 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:top-1.5 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 peer-focus:text-accent-primary rtl:peer-focus:left-auto rtl:peer-focus:translate-x-1/4';
